    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()."assets/"; ?>simple.html"><i class="fa fa-circle-o"></i> Simple tables</a></li>
            <li class="active"><a href="<?php echo base_url()."assets/"; ?>data.html"><i class="fa fa-circle-o"></i> Data tables</a></li>
          </ul>
        </li>
        <li>
